...
export default class NavBar extends Component {
  ...
  render(){
    ...
    let phoneUI = {
      legato : <LegatoPhone app={app} alignment={this.props.options?.phoneUIAlignment? this.props.options?.phoneUIAlignment: this.props.alignment} phoneUITheme={this.props.options.phoneUITheme?this.props.options.phoneUITheme: this.props.template } theme={this.props.theme? this.props.theme: "legato"} obj = {this.props.obj} template={this.props.template} options={this.props.options}/>,
    ...
    let template = {
      ...
      default :   window.innerWidth<state.innerWidth? this.props.options.phoneUI? phoneUI[this.props.options.phoneUI]: phoneUI.default : <DefaultNav app={app} alignment={this.props.alignment} theme={this.props.theme? this.props.theme:state.defaultTheme?state.defaultTheme: "default"} obj = {this.props.obj} template={this.props.template} options={this.props.options}/>,
    }

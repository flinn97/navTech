...
export default class NavBar extends Component {
  ...
  render(){
    ...
    let phoneUI = {
      ...
      legatoDark: <LegatoPhone app={app} alignment={this.props.options?.phoneUIAlignment? this.props.options?.phoneUIAlignment: this.props.alignment} phoneUITheme={this.props.options.phoneUITheme?this.props.options.phoneUITheme: this.props.template } theme={this.props.iphoneStyleTheme? this.props.iphoneStyleTheme: this.props.theme? this.props.theme: "legatoDark"} obj = {this.props.obj} template={this.props.template} options={this.props.options}/>,
